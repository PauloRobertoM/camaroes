<?php include 'components/header.php'; ?>
	...
	<section class="eventos">
		<div class="container">
			<h2 class="titulo-geral">Your event at Camarões</h2>

			<p>We have specific packages for groups of between 30 and 150 people, perfectly suited for weddings,<br />corporate meetings, celebrations and family gatherings. We will do our utmost to<br />customize your event according to your needs.</p>
			<p>For more information, please contact us using the form below.</p>

			<a href="#" data-toggle="modal" data-target="#myModalEvento">REQUEST A PROPOSAL</a>
		</div><!-- container -->
	</section><!-- "eventos -->
